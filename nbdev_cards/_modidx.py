...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'nbdev_cards.card': { 'nbdev_cards.card.Card': ('card.html#card', 'nbdev_cards/card.py'),
            ...
            'nbdev_cards.core': { 'nbdev_cards.core.Card': ('card.html#card', 'nbdev_cards/core.py'),
                                  'nbdev_cards.core.Card.__init__': ('card.html#card.__init__', 'nbdev_cards/core.py'),
                                  'nbdev_cards.core.Card.__str__': ('card.html#card.__str__', 'nbdev_cards/core.py')},
